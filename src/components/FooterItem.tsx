...
export default function FooterItem({ icon, label, link }: FooterItemProps) {
  ...
  return (
    <Etiqueta
      ...
      className="group p-[10px] gap-[10px] hover:gap-[15px] flex  justify-center lg:justify-start items-start transition-all ease-in-out duration-150 cursor-pointer max-w-full "
    >
