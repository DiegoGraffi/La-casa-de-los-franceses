...
function Membresia() {
  ...
  return (
    <div className="mb-20 pt-[120px]">
      ...
      >
        <div
          className={`bg-secundarioOscuro h-[349px] w-full flex items-center justify-center transition-opacity duration-300 ${
        ...
        <div
          className={`bg-secundarioOscuro absolute top-0 left-0 w-full h-[349px] flex justify-center items-center transition-opacity duration-300 gap-[40px] ${
            isHovering ? "opacity-100" : "opacity-0"
          }`}
        >
          <div className="flex gap-[40px] items-start max-w-[1600px] mx-auto">
            <PasosCard
        ...
        <div className="w-full h-full max-w-[1600px] mx-auto absolute top-0">
          <Image
            src="/images/estrella.png"
            alt="estrella"
            width={102}
            height={102}
            className="absolute right-[10%] top-0 -translate-y-[50%] z-30"
          />
        </div>
      </div>

      <div className="flex flex-col mt-[53px] justify-center align-centermax-w-[1600px] mx-auto px-[100px]">
        <SectionTitle title="Elegí tu membresía" />

        <div className="flex flex-row justify-center items-stretch mt-[37px] gap-[10px]">
          <MembresiaCard
        ...
        <div className="flex flex-col gap-[30px] mt-[120px]">
          <section className="flex align-center justify-center">
            <div className="h-[172px] w-[1570px] bg-secundarioOscuro rounded-tr-[55px] rounded-bl-[55px] flex items-center justify-center relative">
              <Image
          ...
          <section className="flex align-center justify-center">
            <div className="h-[172px] w-[1570px] bg-secundarioClaro rounded-tr-[55px] rounded-bl-[55px] flex items-center justify-center">
          ...
          <section className="w-full">
            <div className="group h-[420px] flex flex-col justify-center max-w-[1600px] w-full px-[100px] rounded-tr-[45px] rounded-bl-[75px] relative mx-auto overflow-hidden">
