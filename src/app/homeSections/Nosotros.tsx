  ...
  return (
    <div className="w-full mx-auto flex justify-center items-center mt-[130px] relative group overflow-x-hidden">
      <div className="w-full h-full absolute z-50 flex gap-[130px] justify-center items-center">
        ...
        <div className="flex justify-center items-center flex-1 w-full h-full translate-x-[100%] opacity-0 group-hover:translate-x-[0%] group-hover:opacity-100 z-[1000] transition-all ease-in-out duration-[800ms] delay-700">
      ...
      <div className="w-full h-[580px] relative">
        ...
        <div className="container mx-auto flex justify-center items-center h-full gap-[150px]">
          <div className="absolute w-[280px] h-[280px] z-[500] top-0 left-[20%] -translate-y-[50%]">
