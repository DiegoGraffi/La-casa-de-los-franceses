...
export default function Membresia() {
  return (
    <div className="max-w-[1600px] mx-auto flex h-[550px] relative mt-[150px] px-[100px]">
      <div className="flex-1 h-full relative shrink-0 basis-1/2">
        <Image
          src={fondoMembresia}
          alt="fondo mebresia"
          fill
      ...
      <div className="flex flex-col flex-1 justify-center basis-1/2">
        <div className="w-full h-full px-[50px] lg:px-[100px] flex flex-col justify-center items-start gap-[30px]">
          <h3 className="font-vangeda text-[55px]/[62px] text-terciarioPrincipal ">
            Unite a la membresia
          </h3>
          <p className="text-terciarioPrincipal text-[20px]/[25px] font-light font-bricolage ">
